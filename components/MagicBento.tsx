...
const MagicBento: React.FC<BentoProps> = ({
      ...
      <style>
        {`
          .bento-section {
            ...
            --purple-glow: var(--primary);
            --purple-border: var(--primary);
          }
  ...
  /* POS Solutions (1st card) - Large: spans 2 columns, 2 rows, top-left */
  .card-responsive .card:nth-child(1) {
    grid-column: 1 / 3;
    grid-row: 1 / 3;
  }
  
  /* Business Automations (2nd card) - Small: col 3, row 2 */
  .card-responsive .card:nth-child(2) {
    grid-column: 3;
    grid-row: 2;
  }
  
  /* Project Management (3rd card) - Small: col 4, row 1 */
  .card-responsive .card:nth-child(3) {
    grid-column: 4;
    grid-row: 1;
  }
  
  /* Cloud & DevOps (4th card) - Small: col 3, row 3 */
  .card-responsive .card:nth-child(4) {
    grid-column: 3;
    grid-row: 3;
  }
  
  /* Web Development (5th card) - Large: spans 2 columns, 2 rows, bottom-right */
  .card-responsive .card:nth-child(5) {
    grid-column: 3 / 5;
    grid-row: 2 / 4;
  }
  
  /* Graphics Design (6th card) - Small: col 1, row 3 */
