            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-neutral-300">Reduce operational costs by up to 60%</span>
                </li>
                <li className="flex items-start">
                  <div className="w-6 h-6 bg-business-400 rounded-full flex items-center justify-center mr-3 mt-1">
                    <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-neutral-300">Increase productivity and efficiency</span>
                </li>
                <li className="flex items-start">
                  <div className="w-6 h-6 bg-business-400 rounded-full flex items-center justify-center mr-3 mt-1">
                    <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-neutral-300">Eliminate human errors and inconsistencies</span>
                </li>
                <li className="flex items-start">
                  <div className="w-6 h-6 bg-business-400 rounded-full flex items-center justify-center mr-3 mt-1">
                    <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-neutral-300">24/7 automated monitoring and reporting</span>
                </li>
              </ul>
            </div>
