...
export default function GraphicDesignPage() {
  ...
  const getTechIcon = (tech) => {
    const iconMap = {
      "Adobe Photoshop": faAdobe,
      "Adobe Illustrator": faAdobe,
      "Adobe InDesign": faAdobe,
      "Adobe XD": faAdobe,
      "Adobe After Effects": faAdobe,
      "Figma": faFigma,
      "Sketch": faSketch,
      "InVision": faInvision,
      "Dribbble": faDribbble,
    ...
    return iconMap[tech] || faAdobe // Default to Adobe icon if not found
  }
