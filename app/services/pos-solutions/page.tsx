...
export default function POSSolutions() {
  return (
    <div className="min-h-screen">
      ...
      {/* Benefits Section */}
      <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-orange-900/20 to-red-900/20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <div className="w-6 h-6 bg-orange-400 rounded-full flex items-center justify-center mr-3 mt-1">
                    <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <span className="text-gray-300">Increase sales with faster checkout processes</span>
                </li>
                <li className="flex items-start">
                  <div className="w-6 h-6 bg-orange-400 rounded-full flex items-center justify-center mr-3 mt-1">
                    <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-gray-300">Reduce inventory waste with smart tracking</span>
                </li>
                <li className="flex items-start">
                  <div className="w-6 h-6 bg-orange-400 rounded-full flex items-center justify-center mr-3 mt-1">
                    <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-gray-300">Improve customer experience with modern interface</span>
                </li>
                <li className="flex items-start">
                  <div className="w-6 h-6 bg-orange-400 rounded-full flex items-center justify-center mr-3 mt-1">
                    <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-gray-300">Access real-time data from anywhere</span>
                </li>
              </ul>
            </div>
