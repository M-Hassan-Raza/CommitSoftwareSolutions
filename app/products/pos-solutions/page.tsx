        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-brand-200/20 hover:border-brand-300/30 hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-brand-600 mb-3">Payment Processing</h3>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-brand-200/20 hover:border-brand-300/30 hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-brand-600 mb-3">Inventory Management</h3>
              <p className="text-brand-600/90">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-brand-200/20 hover:border-brand-300/30 hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-brand-600 mb-3">Analytics & Reporting</h3>
              <p className="text-brand-600/90">
      ...
      <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-pos-900/20 to-pos-950/20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-bold text-brand-600 mb-6">Sell More, Manage Better</h3>
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-brand-600/90">Increase sales with faster checkout processes</span>
                </li>
                <li className="flex items-start">
                  <div className="w-6 h-6 bg-pos-400 rounded-full flex items-center justify-center mr-3 mt-1">
                    <svg className="w-3 h-3 text-brand-600" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-brand-600/90">Reduce inventory waste with smart tracking</span>
                </li>
                <li className="flex items-start">
                  <div className="w-6 h-6 bg-pos-400 rounded-full flex items-center justify-center mr-3 mt-1">
                    <svg className="w-3 h-3 text-brand-600" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-brand-600/90">Improve customer experience with modern interface</span>
                </li>
                <li className="flex items-start">
                  <div className="w-6 h-6 bg-pos-400 rounded-full flex items-center justify-center mr-3 mt-1">
                    <svg className="w-3 h-3 text-brand-600" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-brand-600/90">Access real-time data from anywhere</span>
                </li>
              </ul>
            </div>
