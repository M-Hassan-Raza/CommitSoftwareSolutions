            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-brand-200/20 hover:border-brand-300/30 hover:shadow-lg transition-all duration-300">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-brand-600/70">Polaris ERP User</p>
                </div>
              </div>
              ...
              <blockquote className="text-lg text-brand-600/90 italic mb-4">
                &quot;Polaris ERP has revolutionized our business operations.
                The AI-powered queries let us ask questions about our data in
                plain language, and the fraud detection has saved us thousands.
                The deployment was incredibly fast - we were up and running in
                minutes, not months.&quot;
              </blockquote>
              <div className="text-sm text-brand-600/70">
                <p>
                  <strong>Project:</strong> Polaris ERP Implementation
                </p>
                <p>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-brand-200/20 hover:border-brand-300/30 hover:shadow-lg transition-all duration-300">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-brand-600/70">Business Owner</p>
                </div>
              </div>
              <div className="flex mb-4">
                {[...Array(5)].map((_, i) => (
              ...
              <blockquote className="text-lg text-brand-600/90 italic mb-4">
                &quot;The AI-powered solutions from Commit Software have
                transformed how we handle complex business processes. The
                agentic workflows and RAG systems work exactly as promised, and
                the support has been exceptional. Highly recommended for anyone
                looking to leverage cutting-edge AI technology.&quot;
              </blockquote>
              <div className="text-sm text-brand-600/70">
                <p>
                  <strong>Project:</strong> AI Automation Solutions
                </p>
                <p>
                  <strong>Result:</strong> Streamlined business operations
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-brand-200/20 hover:border-brand-300/30 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-brand-600/90 text-sm">
                &quot;The cloud migration was seamless. We saved 60% on
                infrastructure costs while improving performance.&quot;
              </p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-brand-200/20 hover:border-brand-300/30 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-brand-600/90 text-sm">
                &quot;Our new POS system streamlined operations across all
                locations. Staff efficiency increased by 25%.&quot;
              </p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-brand-200/20 hover:border-brand-300/30 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-brand-600/90 text-sm">
                &quot;The brand redesign gave us a professional look that
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-brand-200/20 hover:border-brand-300/30 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-brand-600/90 text-sm">
                &quot;The analytics dashboard transformed how we make decisions.
                We&apos;re 90% faster at identifying trends.&quot;
              </p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-brand-200/20 hover:border-brand-300/30 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-brand-600/90 text-sm">
                &quot;Outstanding work! They delivered our MVP ahead of schedule
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-brand-200/20 hover:border-brand-300/30 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-brand-600/90 text-sm">
                &quot;Professional, reliable, and innovative. They&apos;ve
                become our go-to partner for all software needs.&quot;
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-brand-600/90">
              We&apos;re proud to work with businesses of all sizes across
              various industries
            </p>
          </div>
